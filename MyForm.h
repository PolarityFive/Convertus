...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(34, 83);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(34, 112);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(65, 201);
			...
			this->ClientSize = System::Drawing::Size(198, 236);
...
{
	ConForm^ frm = gcnew ConForm;
	frm->Text = "Convertus from Binary";
	frm->Show(this);
}
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) 
{
	ConForm^ frm = gcnew ConForm;
	frm->Text = "Convertus from Octal";
	frm->Show(this);
}
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) 
{
	ConForm^ frm = gcnew ConForm;
	frm->Text = "Convertus from Decimal";
	frm->Show(this);
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e)
{
	ConForm^ frm = gcnew ConForm;
	frm->Text = "Convertus from Hexadecimal";
	frm->Show(this);
...
{
	MessageBox::Show("Made by Jim Wick during an extremely boring evening. Doot doot.          Timestamp: 25/10/2018 7:20");
}
};
}
